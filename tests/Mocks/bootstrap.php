...
define('MOCK_PATH', ROOT.'tests/Mocks'.DIRECTORY_SEPARATOR);

define('CONTROLLER_PATH', MOCK_PATH.'Controllers'.DIRECTORY_SEPARATOR);
define('MODEL_PATH', MOCK_PATH.'Models'.DIRECTORY_SEPARATOR);
define('VIEW_PATH', MOCK_PATH.'views'.DIRECTORY_SEPARATOR);
